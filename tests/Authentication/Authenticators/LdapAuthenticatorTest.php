 ...
 * @internal
 */
final class LdapAuthenticatorTest extends DatabaseTestCase
{
    use FakeUser;
    ...
    protected function setUp(): void
    {
        ...
        $authenticator = $auth->factory('ldap');
    ...
    public function testLoggedInWithRememberCookie(): void
    {
        ...
        $this->user->createEmailIdentity(['username' => 'fooman', 'email' => 'foo@example.com', 'password' => 'secret']);
    ...
    public function testCheckSuccessOldDangerousPassword(): void
    {
        ...
        fake(
            ...
            [
                'user_id' => $this->user->id,
                'type'    => LDAP::ID_TYPE_EMAIL_PASSWORD,
    ...
    public function noTestAttemptSuccess(): void
    {
        $this->user->createEmailIdentity([
            'username' => 't98kornr',
            'email'    => 'foo@example.com',
